package katka.shoppingpayments.screens.group_detail.adapters;
...
public class GroupDetailAdapter extends ArrayAdapter<Payment> {
    private Context context;
    private ArrayList<Payment> payments;

    public GroupDetailAdapter(Context context, ArrayList<Payment> payments) {
